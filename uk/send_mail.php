...
$mail->addAddress("thetoprating22@gmail.com"); /* Здесь введите Email, куда отправлять */
$mail->setFrom("info@megajokercasino.com");
$mail->AddReplyTo('info@megajokercasino.com', 'MegaJokerCasino');
